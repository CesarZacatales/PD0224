;Realizar un programa que resuelva ecuaciones de primer, segundo y tercer grado. 
;El programa debe recibir como parámetro el tipo de ecuación y los coeficientes de la ecuación y retornar las soluciones.
;utlizando lambda
